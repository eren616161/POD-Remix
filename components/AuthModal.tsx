      ...
      <div className="relative bg-white rounded shadow-card w-full max-w-md p-8 border border-border">
        ...
        {isSent ? (
          <div className="text-center space-y-4">
            <div className="w-16 h-16 mx-auto bg-accent/15 rounded flex items-center justify-center">
            ...
            <p className="text-muted">
              We sent a magic link to <span className="font-medium text-accent">{email}</span>
            </p>
          ...
          <div className="space-y-6">
            <div className="text-center space-y-3">
              <div className="mx-auto flex items-center justify-center">
                <svg className="h-10" viewBox="0 0 233 43">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-background border-2 border-border rounded focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent transition-all placeholder:text-muted/50"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full px-6 py-3 bg-orange text-white font-medium rounded shadow-md hover:shadow-lg hover:bg-orange-hover hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
